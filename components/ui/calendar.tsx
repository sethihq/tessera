  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        dropdown_root: cn(
          "relative has-focus:border-neutral-400 border border-input shadow-xs has-focus:ring-2 has-focus:ring-neutral-400 dark:has-focus:ring-neutral-600 rounded-md",
